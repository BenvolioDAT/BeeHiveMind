...
CoreConfig.settings = Object.freeze({
  ...
  visuals: Object.freeze({
    ...
    plannerRampartPreviewEnabled: false,
    plannerRampartPreviewRoom: null,
    plannerRampartPreviewUseReservations: true,
    plannerRampartPreviewRange: 1,
    plannerRampartPreviewMaxTiles: 120,
    plannerRampartPreviewShowLabels: false,
    plannerRampartPreviewRcl: 8,
    plannerRampartBuildEnabled: false,
    plannerRampartBuildRoom: null,
    plannerRampartBuildMinRcl: 6,
    plannerRampartBuildMaxSitesPerTick: 1,
    plannerRampartBuildUseReservations: true,
    plannerRampartBuildRequirePreviewEnabled: true,
    plannerReservationsEnabled: false,
    plannerReservationsAffectStampBuild: true,
    plannerReservationsAffectLegacyBaseLayout: false,
    plannerReservationVisualsEnabled: false,
    plannerReservationVisualRoom: null,
    plannerReservationMaxVisualTiles: 120,
    plannerReservationControllerRange: 2,
