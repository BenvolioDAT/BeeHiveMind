...
module.exports = Object.freeze({
  ...
  REMOTE_HAUL_PREDICTION_ENABLED: true,
  REMOTE_HAUL_EXPECTED_ARRIVAL_MULTIPLIER: 1.15,
  REMOTE_HAUL_MIN_EXPECTED_ENERGY: 300,
  REMOTE_HAUL_MAX_ASSIGNMENTS_PER_REQUEST: 1,
  REMOTE_SCORE_URGENCY_BONUS: 0.25,
  REMOTE_SCORE_FILL_BONUS: 0.20,
  TRUCKER_REMOTE_SCORE_DEBUG: false,
  LOCAL_TRUCKER_MIN: 1,
  LOCAL_TRUCKER_MAX: 3,
  LOCAL_HAUL_WORKLOAD_ENABLED: true,
  LOCAL_HAUL_ENERGY_PER_TRUCKER_TARGET: 1200,
  LOCAL_HAUL_PRESSURE_EXTRA_LIMIT: 1,
  LOCAL_TRUCKER_BASE_QUOTA: 4,
  LOCAL_CONTAINER_PICKUP_AT: 500,
  LOCAL_CONTAINER_URGENT_AT: 1200,
  LOCAL_CONTAINER_CRITICAL_AT: 1600,
