...
function setHealingMemory(creep, target) { HarabiCreep.recordCombatMemory(creep, 'healing', target); }
function setIdleMemory(creep) { HarabiCreep.recordCombatMemory(creep, 'idle', null); }
