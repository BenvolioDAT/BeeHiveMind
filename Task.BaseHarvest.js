...
module.exports.resolveHarvesterConfig = resolveHarvesterConfig;
...
module.exports.getSpawnBody = function (energyOrRoom, roomOrContext, maybeContext) {
  var spawnModule = require('Task.Spawn');
  var room = null;
  var context = {};
  ...
  var info = spawnModule.getBodyFor('baseharvest', room, context) || {};
  var parts = Array.isArray(info.parts) ? info.parts.slice() : [];
  return parts;
};
...
module.exports.getSpawnSpec = function (room, context) {
  var spawnModule = require('Task.Spawn');
  var info = spawnModule.getBodyFor('baseharvest', room, context) || {};
  var body = Array.isArray(info.parts) ? info.parts.slice() : [];
  return {
    body: body,
