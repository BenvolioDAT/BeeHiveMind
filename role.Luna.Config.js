...
module.exports = Object.freeze({
  ...
  LUNA_PRODUCTIVE_FALLBACK_ENABLED: true,
  LUNA_FALLBACK_BUILD_ENABLED: true,
  LUNA_FALLBACK_UPGRADE_ENABLED: true,
  LUNA_FALLBACK_MAX_RANGE_FROM_SOURCE: 8,
  LUNA_FALLBACK_MAX_ROOM_DISTANCE_FROM_SOURCE: 0,
  LUNA_FALLBACK_ALLOW_HOME_BUILD_IF_IN_HOME: true,
  LUNA_FALLBACK_ALLOW_HOME_UPGRADE_IF_IN_HOME: true,
  LUNA_FALLBACK_MIN_ENERGY: 25,
  LUNA_FALLBACK_RECHECK_TTL: 10,
