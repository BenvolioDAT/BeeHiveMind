...
/*const Builder_Config = [
    ...
    WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,
    WORK,WORK,WORK,WORK,WORK,WORK,// 27 WORK
    CARRY,CARRY,CARRY,CARRY,CARRY,CARRY,// 6 CARRY (small buffer)
    MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,
    MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE// 17 MOVE
  ],
  // 40 parts total
  [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK, 
   CARRY,CARRY,CARRY,CARRY, 
   MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE, MOVE], // 40 (nonMOVE=18, MOVE=12)
  // 32 parts total
  [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK, 
   CARRY,CARRY,CARRY,CARRY, 
   MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE, MOVE], // 32 (nonMOVE=15, MOVE=9)
  // 24 parts total
  [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK, CARRY,CARRY,CARRY, 
   MOVE,MOVE,MOVE,MOVE,MOVE,MOVE,MOVE], // 24 (nonMOVE=12, MOVE=7) ~road-ok for short paths
  [WORK,WORK,WORK,WORK,WORK,WORK,WORK,WORK, CARRY,CARRY,CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE], // 18
  // Late tiers (roads): target nonMOVE≈2/3 total, MOVE≈1/3 total
  [WORK,WORK,WORK,WORK,WORK,WORK,WORK, CARRY,CARRY,CARRY, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE], // 16
  [WORK,WORK,WORK,WORK,WORK,WORK, CARRY,CARRY,CARRY, MOVE, MOVE, MOVE, MOVE, MOVE], // 14
  [WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, MOVE], // 12
  [WORK, WORK, WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE], // 10
  [WORK, WORK, WORK, CARRY, CARRY, MOVE, MOVE, MOVE],    // 8
